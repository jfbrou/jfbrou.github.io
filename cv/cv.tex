...
\textbf{E-mail:} \href{mailto:jean-felix.brouillette@hec.ca}{jean-felix.brouillette@hec.ca} \hspace{0.1cm} $\mid$ \hspace{0.1cm} \textbf{Website:} \href{https://www.jfbrouillette.com/}{www.jfbrouillette.com} \hspace{0.1cm} \\
...
\begin{small}
\href{https://www.jfbrouillette.com/uploads/Markups/Brouillette_JMP.pdf}{\textbf{``Land Market Liberalization and Firm Dynamics: Theory and Evidence from India
.''}} With Dian Jiao and Marshall Mo. \\[-0.5\baselineskip]

\href{https://www.jfbrouillette.com/uploads/Markups/Brouillette_JMP.pdf}{\textbf{``Markups, Firm Scale, and Distorted Economic Growth.''}} With Mohamad Adhami and Emma Rockall. \\[-0.5\baselineskip]

\href{https://www.jfbrouillette.com/uploads/Hopper/draft.pdf}{\textbf{``Women Inventors and Economic Growth.''}}\\[-0.5\baselineskip]
